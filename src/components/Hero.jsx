      ...
      >
        ...
        <div className="head2">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hii there, I'm <p className='name text-[#915EFF]'>Satyaprakash Singh</p>
          </h1>
          <h3>
        ...
        <a
          href="https://github.com/Satya057" target="_blank">
          <AiOutlineGithub />
        </a>
        <a
          href="https://www.linkedin.com/in/satyaprakash-singh-56a7b6149" target="_blank">
          <ImLinkedin />
        </a>
        <a
          href="https://www.instagram.com/satyaprakash057/" target="_blank">
          <AiOutlineInstagram />
        </a>
